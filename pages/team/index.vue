  ...
  <NuxtLayout>
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700">A list of all the customers in your account including their name and email.</p>
      </div>
    </div>
...
// Revised: Changed 'teams' to 'customers' and called 'getCustomers()' 
// to match the updated TeamService.ts and fix the "not a function" error.
