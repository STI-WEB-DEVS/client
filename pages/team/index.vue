<template>
  ...
  <NuxtLayout>
    ...
    <div v-else class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      ...
      <div v-for="member in teamMembers" :key="member.id" class="group relative rounded-xl border border-gray-200 bg-white p-6 shadow-sm hover:shadow-lg hover:border-green-300 transition-all duration-200">
        ...
        <div class="mt-4 pt-4 border-t border-gray-100">
          ...
          <button class="w-full px-4 py-2 text-sm font-medium text-green-600 bg-green-50 rounded-lg hover:bg-green-100 transition-colors">
