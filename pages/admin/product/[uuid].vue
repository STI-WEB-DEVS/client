  ...
  <div class="space-y-6">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
      <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Viewing complete product information including inventory status.</p>
      </div>
    ...
    <div v-else class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
      ...
      <div class="px-6 py-5">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          ...
          <div class="flex border-b pb-2">
            <span class="w-1/3 font-medium text-gray-500">Description:</span>
            <span class="w-2/3 text-gray-900">{{ product?.description || 'No description provided' }}</span>
          </div>
          <div class="flex border-b pb-2">
          ...
          <div class="flex border-b pb-2">
            <span class="w-1/3 font-medium text-gray-500">Stock Quantity:</span>
            <span class="w-2/3">
              <span 
                :class="[
          ...
          <div class="flex border-b pb-2">
            <span class="w-1/3 font-medium text-gray-500">Status:</span>
            <span class="w-2/3">
              <span 
                :class="[
                  'inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium',
                  product?.stock_quantity <= 0 ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'
                ]"
              >
