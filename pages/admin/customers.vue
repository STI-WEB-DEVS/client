      ...
      <div v-if="viewModal" class="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
        <div class="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl">
          ...
          <div class="flex gap-3 mt-6">
            <button @click="editCustomer(selected)" class="flex-1 py-2.5 rounded-xl text-sm font-semibold text-white" style="background: linear-gradient(135deg, #1e3a5f, #2563eb);">Edit</button>
