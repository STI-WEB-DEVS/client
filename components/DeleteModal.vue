    ...
    <div class="flex min-h-screen items-center justify-center p-4">
      ...
      <div class="relative bg-white rounded-lg shadow-xl max-w-md w-full p-6">
        <div class="text-center">
          ...
          <h3 class="mt-4 text-lg font-semibold text-gray-900">Delete {{ itemType }}</h3>
          <p class="mt-2 text-sm text-gray-500">Are you sure you want to delete "{{ itemName }}"? This action cannot be undone.</p>
          <div class="mt-6 flex justify-end gap-3">
            ...
            <button @click="$emit('confirm')" class="px-4 py-2 text-sm font-medium text-white bg-red-600 rounded-md hover:bg-red-700">
              Delete
            </button>
          </div>
        </div>
