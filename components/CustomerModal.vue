...
const props = defineProps<{
  open: boolean;
  loading: boolean;
  customer: any | null; // If null, we are sin "Create" mode
}>();
...
// Determine mode based on presence of customer data
const isEditMode = computed(() => !!props.customer);

// Watch for changes in the customer prop to populate the form
...
const handleSubmit = () => {
  // Emit the form data back to the parent
