<template>
  ...
  <img class="mx-auto h-28 w-auto" src="/Resources/nutrimatchlogo.png" alt="NutriMatch" />
      <h2 class="mt-6 text-center text-2xl/9 font-bold tracking-tight text-gray-300">Sign in to your account</h2>
    </div>
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
      <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
        <form class="space-y-6" method="POST" @submit.prevent="handleSubmit">
          ...
          <div>
            <button type="submit" class="flex w-full justify-center rounded-md px-3 py-1.5 text-sm/6 font-semibold text-white shadow-sm" style="background-color: #5AA7A7;" @mouseenter="e => e.target.style.backgroundColor = '#1a2e35'" @mouseleave="e => e.target.style.backgroundColor = '#5AA7A7'">Sign in</button>
          </div>
        </form>
