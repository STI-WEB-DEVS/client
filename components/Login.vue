          ...
          <div>
            ...
            <div class="mt-2">
              <input
                ...
                class="block w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-base text-gray-900 placeholder:text-gray-400 focus:border-green-600 focus:outline-none focus:ring-1 focus:ring-green-600 sm:text-sm/6 shadow-sm"
              />
            </div>
          </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    await navigateTo(response.user.role === "admin" ? "/admin/dashboard" : "/dashboard");
  } catch (err: any) {
