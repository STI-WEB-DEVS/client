<template>
  <!--
    ...
    ```
  -->
  <div class="flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-">
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <img class="mx-auto h-20 w-auto" src="C:\Users\PC1\Desktop\New folder\client\resources\Logo.png" alt="Your Company" />
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
      ...
      <p class="mt-10 text-center text-sm/6 text-gray-500">
        Not a member?
        {{ ' ' }}
        <a href="#" class="font-semibold text-green-600 hover:text-green-500">Start a 14 day free trial</a>
      </p>
    </div>
  </div>
</template>
