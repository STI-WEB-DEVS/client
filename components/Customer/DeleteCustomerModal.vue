      ...
      <div v-if="open" class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative z-10 w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
          ...
          <p class="mt-3 text-gray-600">
            Are you sure you want to delete <span class="font-medium">"{{ customerName }}"</span>?
          ...
          <div class="mt-8 flex justify-end gap-3">
            ...
            <button @click="handleDelete" :disabled="loading"
              class="px-5 py-2.5 bg-red-600 text-white rounded-lg font-medium hover:bg-red-700 disabled:opacity-50">
