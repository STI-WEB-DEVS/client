<template>
  <div>
        ...
        <div class="fixed inset-0 flex">
          ...
          >
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div
                class="relative flex grow flex-col gap-y-5 overflow-y-auto bg-blue-500 px-6 pb-4 ring-1 ring-white/10"
              >
    ...
    <div
      class="hidden bg-blue-500 ring-1 ring-white/10 lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col"
    >
      <div
        class="flex grow flex-col gap-y-5 overflow-y-auto bg-black/10 px-6 pb-4 text-black"
      >
        ...
        <nav class="flex flex-1 flex-col">
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <li class="mt-auto">
              <a
                href="/settings"
                class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-black hover:bg-white/5 hover:text-white"
              >
    ...
    <div class="lg:pl-72">
      <div
        class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8 shadow-sm shadow-gray-200"
      >
        <button
          type="button"
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6 shadow-lg shadow-gray-400 md:shadow-xl">
