          ...
          <div class="flex flex-1"></div> <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <Menu as="div" class="relative">
              <MenuButton class="relative flex items-center">
                ...
                <img class="size-8 rounded-full bg-gray-50 outline outline-1 -outline-offset-1 outline-black/5" src="https://www.shutterstock.com/image-vector/user-profile-icon-vector-avatar-600nw-2558760599.jpg" alt="" />
                <span class="hidden lg:flex lg:items-center">
                  <span class="ml-4 text-sm/6 font-semibold text-gray-900" aria-hidden="true">Rylle Manco</span>
