...
const navigation = [
  ...
  { name: 'Team',       href: '/admin/team/index',       icon: UsersIcon },
  { name: 'Projects',   href: '/admin/projects/projects',   icon: FolderIcon },
  { name: 'Calendar',   href: '/admin/calendar/calendar',   icon: CalendarIcon },
  { name: 'Documents',  href: '/admin/documents/documents',  icon: DocumentDuplicateIcon },
  { name: 'Reports',    href: '/admin/reports/reports',    icon: ChartBarIcon },
  { name: 'Products',   href: '/admin/products/products',   icon: ArchiveBoxIcon },
  { name: 'Customers',  href: '/admin/customer/customers',   icon: UsersIcon },
]

const userNavigation = [
  { name: 'Your profile', href: '/admin/profile/profile' },
  { name: 'Sign out',     href: '/' },
]
