      ...
      <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-black/10 px-6 pb-4">
        ...
        <nav class="flex flex-1 flex-col">
          <ul role="list" class="flex flex-1 flex-col gap-y-7">
            ...
            <li class="mt-auto">
              <a href="#" class="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm/6 font-semibold text-[#7D5A50] hover:bg-[#B4846C] hover:text-white">
                <Cog6ToothIcon class="size-6 shrink-0" aria-hidden="true" />
                Settings
              </a>
            </li>
...
const navigation = [
  ...
  { name: 'Cafe Owners', href: '/team', icon: UsersIcon },
